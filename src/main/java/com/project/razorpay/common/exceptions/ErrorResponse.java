...
public record ErrorResponse (
    ...
    public static ErrorResponse of(String errorCode, String errorDescription, List<FieldError> errors) {
        return new ErrorResponse(errorCode, errorDescription, LocalDateTime.now(), errors);
    }
}
